...
export function NoticeStrip({ settings }: { settings?: Record<string, string> }) {
  ...
  return (
    <div className="bg-[#062B0A] text-[#FFF8E7] text-[13px] flex items-center gap-3.5 px-4 sm:px-6 lg:px-12 py-[9px]">
      <span
      ...
      <a
        href={url}
        className="ml-auto text-[#FFB203] font-semibold text-xs whitespace-nowrap hover:underline shrink-0"
      >
