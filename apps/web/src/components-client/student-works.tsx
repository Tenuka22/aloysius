    ...
    <section className="py-16 sm:py-20 bg-background">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div ref={headingRef} className="flex items-end justify-between mb-8">
          <div>
            <span className="text-xs font-semibold uppercase tracking-widest text-[#c9a227] mb-2 block">Showcase</span>
            <h2 className="text-2xl sm:text-3xl font-bold">Latest Student Works</h2>
          </div>
          <a href="/student-works" className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors inline-flex items-center gap-1.5">
            View All
      ...
      <div ref={ref} className="flex gap-5 overflow-x-auto px-4 sm:px-6 lg:px-8 pb-4 snap-x snap-mandatory scrollbar-hide">
        {works.length === 0 ? (
          ...
          >
            ...
            <div className="text-sm font-semibold mb-0.5 group-hover:text-[#c9a227] transition-colors">{work.title}</div>
