...
export const Route = createFileRoute(
  "/activities-admin/$activityId/announcements/global",
)({
  component: ActivityAdminGlobalAnnouncements,
});

function ActivityAdminGlobalAnnouncements() {
  ...
  const announcementsQuery = useQuery(
    orpc.announcements.list.queryOptions({
      input: { global: true, pageSize: 100 },
    }),
  );
  ...
  return (
    <div className="flex flex-col">
      <header className="flex h-16 shrink-0 items-center gap-2 border-b px-4">
        ...
        <h1 className="text-lg font-semibold">Global Announcements</h1>
                ...
                {item.reviewStatus === "pending" && (
                  <div className="flex shrink-0 gap-2">
                    ...
                    <Button
                      ...
                      onClick={() =>
                        setRejectItem({ id: item.id, title: item.title })
                      }
                      disabled={reviewMutation.isPending}
                    >
