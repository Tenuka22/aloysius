...
import { IconArrowLeft, IconCheck, IconX, IconShieldCheck } from "@tabler/icons-react";
...
function ActivityContentPage() {
  ...
  const saveAdminEmailMutation = useMutation(
                ...
                {isEditingEmail ? (
                  <div className="flex gap-2">
                    <Input
                      ...
                      onKeyDown={(e) => {
                        if (e.key === "Enter") {
                          saveAdminEmailMutation.mutate({
                            id,
                            adminEmail: adminEmailInput || undefined,
                          });
                        } else if (e.key === "Escape") {
                          setIsEditingEmail(false);
                          setAdminEmailInput(activity.adminEmail ?? "");
                        }
                      }}
                    ...
                    <Button
                      ...
                      disabled={saveAdminEmailMutation.isPending}
                    >
                      Save
                    </Button>
                    <Button
                  ...
                  <>
                    <p className="text-sm font-medium">
                      {activity.adminEmail || "Not set"}
                    </p>
                    <p className="text-[11px] text-muted-foreground mt-1">
                      The person responsible for managing this {activity.type}&apos;s roster and content. They can
