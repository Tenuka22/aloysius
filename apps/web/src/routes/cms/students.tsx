    ...
    <>
      <div {...stylex.props(styles.screenHead)}>
        <div {...stylex.props(styles.headingWrap)}>
          <p {...stylex.props(styles.eyebrow)}>Pages / Students</p>
          <h1 {...stylex.props(styles.heading)}>Students Editor</h1>
          <p {...stylex.props(styles.note)}>
            Edit the Student Life page header and activities section.
          </p>
        </div>
        <HomepageEditorActions
