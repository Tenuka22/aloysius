...
export async function seed() {
  ...
  const settings = [
    ...
    { key: "about", value: "Founded in 1979, St. Xavier's High School has been a beacon of academic excellence and holistic development. Our campus spans 12 acres with state-of-the-art facilities for academics, sports, and the arts." },
  ];
  ...
  const newsItems = [
    ...
    },
    {
      ...
      content: "Xaviera 2026, our annual cultural festival, will be held from February 20-22. This year's theme is 'Unity in Diversity' and will feature performances by students, guest artists, and alumni.\n\nHighlights include a classical dance performance by alumni group Nritya, a rock concert by student band The Frequencies, and a play directed by drama teacher Mrs. Deepa Nair.\n\nRegistrations for individual and group events are now open through the school app.",
      excerpt: "Xaviera 2026 cultural festival scheduled for February 20-22 with the theme 'Unity in Diversity'.",
  ...
  const announcements = [
    ...
    },
    {
      ...
      content: "The school library will remain open until 5:00 PM on weekdays starting January 20 to support students preparing for mid-term exams.\n\nAdditional reference materials and past question papers have been made available. Students must carry their library cards for entry.",
    ...
    },
    {
      ...
      content: "All students participating in the Annual Day program must attend rehearsals starting January 27. Rehearsals will be held in the school auditorium from 3:30 PM to 5:30 PM.\n\nA attendance is mandatory for performers. Parents of participating students will receive a separate communication regarding the event schedule.",
  ...
  const events = [
    {
      ...
      content: "Join us for the 28th Annual Science Exhibition featuring innovative projects from students across all grades. Categories include Physics, Chemistry, Biology, Computer Science, and Environmental Science.",
    ...
    },
    {
      ...
      content: "St. Xavier's hosts the 12th Inter-School Football Tournament with 16 teams competing over two days. Cheer for our team as they defend their title.",
    ...
    },
    {
      ...
      content: "A hands-on workshop conducted by industry experts from TechVista Solutions on introduction to AI, machine learning basics, and building your first neural network. Open to grades 9-12.",
    ...
    },
    {
      ...
      content: "Three days of music, dance, drama, and art celebrating 'Unity in Diversity'. Features student performances, guest artists, alumni reunion, and food stalls.",
    ...
    },
    {
      ...
      content: "Expert career counselors from CareerGuidance India will conduct individual and group sessions for grade 12 students. Topics include engineering, medicine, liberal arts, and overseas education options.",
    ...
    },
    {
      ...
      content: "The Eco Warriors Club organizes a campus-wide waste segregation awareness drive. Students will set up educational booths and conduct interactive sessions on recycling and composting.",
  ...
  // ── Event Records ──
  const eventRecords = [
    { eventId: eventsData[0]!.id, outcome: "success" as const, reason: "Well-attended with over 800 visitors", notes: "All exhibits functioned correctly. Three projects received external recognition." },
    { eventId: eventsData[1]!.id, outcome: "success" as const, reason: "Smooth tournament with 16 participating schools", notes: "Our team finished as runners-up. Good sportsmanship displayed." },
    { eventId: eventsData[5]!.id, outcome: "postponed" as const, reason: "Heavy rainfall forecast for the scheduled date", notes: "Rescheduled to next Friday. Volunteers notified." },
  ];
  ...
  const achievements = [
    {
      ...
      description: "Arjun Nair and Ishita Verma won gold medals in the National Science Olympiad held in Delhi, competing against 2,000 participants from 300 schools.",
    ...
    },
    {
      ...
      description: "The school basketball team won the Karnataka State Inter-School Championship for the third consecutive year, defeating Bishop Cotton School in the finals 68-52.",
    ...
    },
    {
      ...
      description: "St. Xavier's received the Karnataka State Education Award for Best School Art Program, recognizing our commitment to arts education and student exhibitions.",
    ...
    },
    {
      ...
      description: "Team 'ByteForce' won the CodeX National Coding Championship, building an AI-powered waste sorting system that impressed judges from Google and Microsoft.",
      category: "academic" as const,
    ...
    },
    {
      ...
      description: "The school received the prestigious Green Flag Certification from the Foundation for Environmental Education for our sustainability initiatives including solar panels and rainwater harvesting.",
  ...
  const studentWorks = [
    {
      ...
      description: "A series of 8 digital illustrations exploring the feeling of isolation in crowded city spaces. Each piece uses a muted color palette with selective pops of color to represent moments of connection.",
    ...
    },
    {
      ...
      description: "A machine learning model trained on 10,000+ images to classify waste into recyclable, compostable, and landfill categories. Built with TensorFlow and deployed as a mobile app.",
    ...
    },
    {
      ...
      description: "A 12-minute short film about a friendship that forms between two students from different backgrounds during a monsoon season. Shot on campus and in the streets of Bangalore.",
    ...
    },
    {
      ...
      description: "A research paper examining the architectural heritage of colonial-era buildings in Bangalore and their preservation challenges. Includes original photography and interviews with conservation experts.",
    ...
    },
    {
      ...
      description: "An original composition for piano and flute inspired by the monsoon season. Performed at Xaviera 2025 and recorded in the school music room.",
    ...
    },
    {
      ...
      description: "A full-stack web application that displays real-time data on school bus locations, cafeteria menu, library availability, and event schedules. Built with React and Node.js.",
      category: "code" as const,
  ...
  const galleries = [
    {
      ...
      description: "Moments from the 27th Annual Science Exhibition held in December 2025, featuring over 50 student projects.",
      eventId: eventsData[0]?.id ?? null,
      tags: ["science", "exhibition"],
    },
    {
      title: "Sports Day 2025",
      description: "Action shots from the annual Sports Day featuring track events, relay races, and house competitions.",
      eventId: eventsData[1]?.id ?? null,
      tags: ["sports", "athletics"],
    },
    {
      title: "Art Exhibition - Perspectives",
      description: "Photos from the student art exhibition at Karnataka Chitrakala Parishath showcasing paintings, digital art, and installations.",
      achievementId: null,
      tags: ["art", "exhibition"],
    },
    {
      title: "Campus Life 2025-26",
      description: "A collection of candid moments from everyday life at St. Xavier's - classrooms, corridors, lunch breaks, and celebrations.",
  ...
  for (const item of galleries) {
    const data = {
      ...
      authorName: faker.helpers.arrayElement([
        "Mr. Rajesh Menon", "Mrs. Priya Kapoor", "Dr. Sunita Iyer", "Mr. Anil Deshmukh",
        "Mrs. Kavitha Rao", "Mr. Sanjay Mishra", "Mrs. Deepa Nair", "Dr. Amit Saxena",
      ]),
